...
class Pipe:
    ...
    def get_anthropic_models(self):
        return [
            {
                "id": "claude-opus-4-5",
                "name": "claude-opus-4.5 (expensive)",
            },
            {
                "id": "claude-sonnet-4-5",
                "name": "claude-sonnet-4.5 (normal)",
            },
            {
                "id": "claude-haiku-4-5",
    ...
    def pipe(self, body: dict) -> Union[str, Generator, Iterator]:
        ...
        # Anthropic models cannot accept both temperature and top_p together.
        # Preference order:
        #   1. If user explicitly sets temperature → use temperature only.
        #   2. Else if user explicitly sets top_p → use top_p only.
        #   3. Else → use default temperature 0.8
        ...
        if temperature is not None:
            ...
            payload["temperature"] = 0.8  # sensible default

        # top_k is still allowed with temperature
